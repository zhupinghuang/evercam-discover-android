...
public class ResourceHelper
{
	...
	{
		return Constants.PREFIX_HTTP + camera.getUsername() + ":" + camera.getPassword() + "@" + camera.getIP()
				+ ":" + camera.getExthttp();
	}
	...
	{
		return Constants.PREFIX_RTSP + camera.getUsername() + ":" + camera.getPassword() + "@" + camera.getIP()
				+ ":" + camera.getExtrtsp() + camera.getH264();
	}

	public static String getInternalFullRtspURL(Camera camera)
	{
		return Constants.PREFIX_RTSP  + camera.getUsername() + ":" + camera.getPassword() + "@" + camera.getIP()
				+ ":" + camera.getRtsp() + camera.getH264();
	}
}
