...
public class MediaList
{
    ...
    public void add(Media media, boolean noVideo, boolean noHardwareAcceleration)
    {
        ...
        signal_list_event(EventHandler.CustomMediaListItemAdded, mInternalList.size() - 1, media
                .getLocation());
    }
    ...
    public void clear()
    {
        ...
        {
            signal_list_event(EventHandler.CustomMediaListItemDeleted, i, mInternalList.get(i).m
                    .getLocation());
        }
        mInternalList.clear();
    }
    ...
    private native int expandMedia(LibVLC libvlc_instance, int position, ArrayList<String>
            children);
