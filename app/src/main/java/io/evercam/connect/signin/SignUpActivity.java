...
public class SignUpActivity extends Activity
{
    ...
    private void setSpinnerAdapter()
    {
        ...
        String[] countryArray = join(new String[]{getResources().getString(R.string
                .spinnerFistItem)}, set.toArray(new String[0]));
    ...
    public class CreateUserTask extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... args)
        {
            try
            {
                ...
                SharedPrefsManager.saveEvercamCredential(sharedPrefs, evercamUser, userDetail.getPassword());
                return null;
            }
    ...
    private void readFromAccount()
    {
        try
        {
            ...
            Log.d(TAG, "emails" + profile.possibleEmails().size() + "\nnames" + profile.possibleNames().size() + profile.primaryEmail());
        }
        catch(Exception e)
        {
