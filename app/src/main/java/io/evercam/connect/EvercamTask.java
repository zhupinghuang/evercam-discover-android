...
public class EvercamTask extends AsyncTask<Void, Void, Void>
{
    ...
    public static String getUsername(String vendorId)
    {
        ...
        {
            Log.e("evercamdiscover", "Exception with get default username " + vendorId + e
                    .getMessage());
        }
        return "";
    }
    ...
    public static String getPassword(String vendorId)
    {
        ...
        {
            Log.e("evercamdiscover", "Exception with get default password" + vendorId + e
                    .getMessage());
        }
        return "";
    }
    ...
    private static class FillAuthOnlyTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            cameraOperation.updateAttributeString(camera.getIP(), camera.getSsid(), "username", username);
            cameraOperation.updateAttributeString(camera.getIP(), camera.getSsid(), "password", password);
